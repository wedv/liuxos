...
//                    lxb.app.renderList($c, $pc);
        ...
        html: {
            init: function() {
                ...
                $dom += '<div style="border:1px solid gray;line-height:28px;position: absolute;right:576px;top:0;">留底<input id="lxb-min-money" value style="width:40px;" />元</div><script>jQuery("#lxb-min-money").keydown(function(){setCookie("lxb-min-money", jQuery("#lxb-min-money").val())});setInterval(function(){var min = jQuery("#lxb-min-money").val();var min_cookie = getCookie("lxb-min-money");if(min != min_cookie && min_cookie != 0){jQuery("#lxb-min-money").val(min_cookie);}}, 3000);</script>';
